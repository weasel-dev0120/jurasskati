...
{!! BootForm::bind($data) !!}
    ...
    <div class="content">
        @hasanyrole('administrator|superuser')
        <div class="row">
        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                {!! BootForm::email(__('Contact form destination email'), 'form_email') !!}
                <br>
                {!! BootForm::text(__('Facebook URL'), 'facebook') !!}
                {!! BootForm::text(__('Instagram URL'), 'instagram') !!}
                {!! BootForm::text(__('Youtube URL'), 'instagram') !!}
                <br>
                <div class="fieldset-media fieldset-image">
                    {!! BootForm::hidden('home_cover_image') !!}
                    @if (isset($data->home_cover_image) and $data->home_cover_image)
                    <div class="fieldset-preview">
                        <img class="img-fluid" src="{{ Storage::url('settings/'.$data->home_cover_image) }}" alt="">
                        {{-- <small class="text-danger delete-attachment" data-table="settings" data-id="" data-field="home_cover_image">@lang('Delete')</small> --}}
                    </div>
                    @endif
                    <div class="fieldset-field">
                        {!! BootForm::file(__('Home page cover image'), 'home_cover_image') !!}
                    </div>
                </div>
                <div class="fieldset-media fieldset-image">
                    {!! BootForm::hidden('home_intro_image') !!}
                    @if (isset($data->home_intro_image) and $data->home_intro_image)
                    <div class="fieldset-preview">
                        <img class="img-fluid" src="{{ Storage::url('settings/'.$data->home_intro_image) }}" alt="">
                        {{-- <small class="text-danger delete-attachment" data-table="settings" data-id="" data-field="home_intro_image">@lang('Delete')</small> --}}
                    </div>
                    @endif
                    <div class="fieldset-field">
                        {!! BootForm::file(__('Home page intro image'), 'home_intro_image') !!}
                    </div>
                </div>
